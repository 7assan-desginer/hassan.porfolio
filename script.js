...
function checkout(plan,price){currentPlan=plan;currentPrice=price;currentOrderId=makeOrderId();mplan.textContent=plan;mprice.textContent='$'+price;document.getElementById('orderId').textContent=currentOrderId;document.getElementById('paymentStep').classList.add('hidden');modal.classList.add('show')}
